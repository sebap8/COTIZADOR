...
public class BuscarCliente extends JFrame {
	 ...
	 * Create the frame.
	 */
	public BuscarCliente(String ventana) {
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Vector<String> productos = Controlador.getInstancia().obtenerClientesBusqueda(textField.getText());
		...
		btnSeleccionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(ventana=="3") {//MODIFICAR CLIENTE
					GenerarPresupuesto.getInstancia().setCliente(jTable1.getValueAt(jTable1.getSelectedRow(), 0).toString());
				}
				dispose();
			}
		});
