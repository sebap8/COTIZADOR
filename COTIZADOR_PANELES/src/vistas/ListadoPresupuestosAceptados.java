...
public class ListadoPresupuestosAceptados extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListadoPresupuestosAceptados frame = new ListadoPresupuestosAceptados();
	 ...
	 * Create the frame.
	 */
	public ListadoPresupuestosAceptados() {
        ...
        presupuestos=Controlador.getInstancia().obtenerPresupuestosAceptados();
